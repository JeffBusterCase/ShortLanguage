module Finder
    ...
    module Super
        ...
        def self.find num, key
            ...
            # But just worked with the number 252 in F function
...
puts "Part 1\n"
hided = Finder::Super.hide(46, 34)
p hided

p Finder::Super.find(hided, 5)

puts "\nPart 2\n"
hided = Finder::Super.hide(90, 50)
p hided
...
p Finder::Super.F(252)

p Finder::Super.hide(202, 152)
p Finder::hide(202, 152)
